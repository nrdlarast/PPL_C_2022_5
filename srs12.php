<?php include'header.html' ?>
  <div class="row">
    ...
    <div class="flex flex-col items-center h-full overflow-hidden border-r border-grey-400 text-gray-700" style="border-color: black;">
        ...
        <!-- <div class="wrapper"> -->
        <div class="pfppo">
            <img src="img/elmore.jpg" class="image--cover" style="margin-left: auto; margin-right: auto; margin-bottom: 13px;">
            <h2 style="text-align: center;">Departemen Informatika</h2>
            <h2 style="text-align: center;">DepartemenInformatika@gmail.com</h2>
        </div>
