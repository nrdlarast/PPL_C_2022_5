...
(0, '100001', 1, 18, 'achmad.jpg', 0, 3.5, 4, 'zara.jpg', 'disetujui'),
(1, '100001', 2, 24, '', 0, 4, 1, '', 'disetujui'),
(2, '200001', 2, 18, 'Untitled Workspace.png', 0, 0, 0, '', 'disetujui'),
(3, '300001', 3, 18, 'Untitled Workspace.png', 0, 0, 0, '', 'disetujui'),
(4, '100001', 3, 24, '', 0, 0, 0, '', 'disetujui'),
...
(8, '100001', 4, 24, '', 0, 0, 0, '', 'disetujui'),
(9, '100001', 5, 0, '', 0, 0, 0, '', 'disetujui'),
(10, '100001', 6, 0, '', 0, 0, 0, '', 'disetujui'),
(11, '100001', 7, 0, '', 0, 0, 0, '', 'disetujui'),
(12, '100001', 8, 0, '', 0, 0, 0, '', 'disetujui');
...
INSERT INTO `pkl` (`pkl_id`, `status_pkl`, `nilai_pkl`, `berkas_pkl`) VALUES
('300001', 'belum', 0, ''),
('300002', 'lulus', 3, '300002.jpg');
...
CREATE TABLE `skripsi` (
  ...
  `nilai_skripsi` varchar(5) NOT NULL,
...
INSERT INTO `skripsi` (`skripsi_id`, `status_skripsi`, `nilai_skripsi`, `berkas_skripsi`, `lama_study`, `tanggal_sidang`) VALUES
