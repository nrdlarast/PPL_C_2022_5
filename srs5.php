    ...
    <div class="row khusus1 profile">
        ...
        <div class="col-5" style="padding-right: 70px;">
            ...
            <select name="status" id="status" class="form-control" required>
                            ...
                            <option value="belum" <?php if (isset($status) && $status=="belum") echo 'selected="true"'; ?>>Belum PKL</option>
                            <option value="sedang" <?php if (isset($status) && $status=="sedang") echo 'selected="true"'; ?>>Sedang PKL</option>
                            <option value="lulus" <?php if (isset($status) && $status=="lulus") echo 'selected="true"'; ?>>Lulus PKL</option>
                            </select>
